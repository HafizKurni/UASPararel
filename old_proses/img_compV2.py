...
def compress_image_color(image_path, compression_ratio):
    ...
    with concurrent.futures.ThreadPoolExecutor() as executor:
        futures = [executor.submit(compress_channel, channel, compression_ratio) for channel in channels]
        compressed_channels = [future.result() for future in concurrent.futures.as_completed(futures)]
...
if __name__ == "__main__":
    ...
    compression_ratio = 0.5  # Keep 50% of the frequencies
